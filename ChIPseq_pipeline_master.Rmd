...
blacklist_path <- "~/Desktop/R_functions/ChIP-seq_pipeline/ChIPseq_pipeline//wgEncodeHg19ConsensusSignalArtifactRegions.bed"
genome <- "hg19"

fastQ_to_bigwig_to_peaks(fastq_path = fastq_path, sample_sheet_path = sample_sheet_path, genome = genome, buildIndex = TRUE)
