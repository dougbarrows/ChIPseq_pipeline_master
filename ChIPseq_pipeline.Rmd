...
fastQ_to_bigwig_to_peaks(fastq_path)
...
# extract the base part of the name of each fast1 file so that this can be ussed as the base for output files generated below
